...
const mockRecentAttempts: RecentAttempt[] = [
  {
    id: '1',
    testName: 'JEE Main Physics Mock Test #3',
    exam: 'JEE Main',
    score: 72,
    totalQuestions: 30,
    accuracy: 80,
  ...
  {
    id: '2', 
    testName: 'NEET Biology Full Syllabus',
    exam: 'NEET',
    score: 156,
    totalQuestions: 45,
    accuracy: 87,
  ...
  {
    id: '3',
    testName: 'JEE Advanced Mathematics',
    exam: 'JEE Advanced',
    score: 45,
    totalQuestions: 20,
    accuracy: 75,
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      <div className="flex items-center space-x-3 mb-2">
                        <h3 className="font-medium text-gray-900">{attempt.testName}</h3>
                      ...
                      <div className="flex items-center space-x-6 text-sm text-gray-600">
                        <div className="flex items-center space-x-1">
                          ...
                          <span>{attempt.score}/{attempt.totalQuestions} ({attempt.accuracy}%)</span>
                        </div>
                        <div className="flex items-center space-x-1">
