...
if (!admin.apps.length) {
  try {
    ...
    console.log('Failed to initialize with default credentials, trying with credential from environment...');
 ...
 * @param {string} name - The chapter name to convert
 * @returns {string} The slug format of the name
 */
 ...
 * @param {string} chapterId - The chapter document ID
 * @param {string} subcollectionName - The name of the subcollection to count
 * @returns {Promise<number>} The number of documents in the subcollection
 */
